...
```{r dist_weight_boot-multiple, results='hide', fig.height=4, fig.width=10.5, out.width='90%', fig.align='center'}
...
```{r dist_weight_boot-ndvi, results='hide', fig.height=4, fig.width=10.5, out.width='90%', fig.align='center'}
